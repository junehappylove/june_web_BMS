package com.june.controller.weixin.command;
...
public class CommandController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		if(!Jurisdiction.buttonJurisdiction(menuUrl, Const.ADD)){return null;} //校验权限
	...
	public void delete(PrintWriter out){
		...
		if(!Jurisdiction.buttonJurisdiction(menuUrl, Const.DEL)){return;} //校验权限
		PageData pd = new PageData();
		try{
			pd = this.getPageData();
	...
	public ModelAndView edit() throws Exception{
		...
		if(!Jurisdiction.buttonJurisdiction(menuUrl, Const.EDIT)){return null;} //校验权限
		ModelAndView mv = this.initMV();
		PageData pd = new PageData();
		pd = this.getPageData();
	...
	public ModelAndView list(Page page){
		...
		if(!Jurisdiction.buttonJurisdiction(menuUrl, Const.CHA)){return null;} //校验权限
		ModelAndView mv = this.initMV();
		PageData pd = new PageData();
		try{
			pd = this.getPageData();
