package com.june.controller.system.head;
...
import com.june.util.SmsUtil;
import com.june.util.Tools;
import com.june.util.Watermark;
import com.june.util.mail.SimpleMailSender;
	...
	public Object sendSms(){
		...
		if("yes".endsWith(isAll)){
			try {
				...
				userList = "appuser".equals(fmsg) ? appuserService.listAll(pd):userService.listAll(pd);
