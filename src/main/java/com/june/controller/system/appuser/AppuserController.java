package com.june.controller.system.appuser;
...
import com.june.service.system.appuser.AppuserService;
...
public class AppuserController extends BaseController {
	...
	public ModelAndView saveU(PrintWriter out) throws Exception{
		...
		if(null == appuserService.findByUId(pd)){
			if(Jurisdiction.buttonJurisdiction(menuUrl, Const.ADD)){appuserService.save(pd);} //判断新增权限
	...
	public ModelAndView editU(PrintWriter out) throws Exception{
		...
		if(Jurisdiction.buttonJurisdiction(menuUrl, Const.EDIT)){appuserService.edit(pd);}
		mv.addObject(Const.MESSAGE,Const.SUCCESS);
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteU(PrintWriter out){
		...
		try{
			pd = this.getPageData();
			if(Jurisdiction.buttonJurisdiction(menuUrl, Const.DEL)){appuserService.delete(pd);}
	...
	public Object deleteAllU() {
		...
		try {
			...
			if(null != USER_IDS && !"".equals(USER_IDS)){
				...
				if(Jurisdiction.buttonJurisdiction(menuUrl, Const.DEL)){appuserService.deleteAll(ArrayUSER_IDS);}
	...
	public ModelAndView exportExcel(){
		...
		try{
			if(Jurisdiction.buttonJurisdiction(menuUrl, Const.CHA)){	
				...
				List<PageData> userList = appuserService.listAll(pd);
