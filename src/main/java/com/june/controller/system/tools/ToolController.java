package com.june.controller.system.tools;
...
import com.june.util.MapDistance;
import com.june.util.PageData;
import com.june.util.PathUtil;
import com.june.util.TwoDimensionCode;
...
public class ToolController extends BaseController {
	...
	public Object severTest(){
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = Const.SUCCESS,str = "",rTime="";
		try{
	...
	public Object createTwoDimensionCode(){
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = Const.SUCCESS, encoderImgId = this.get32UUID()+".png"; //encoderImgId此处二维码的图片名
	...
	public Object readTwoDimensionCode(){
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = Const.SUCCESS,readContent="";
	...
	public Object getDistance(){
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = Const.SUCCESS,distance="";
		try {
